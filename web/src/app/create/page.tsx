  ...
  if (mintState.status === "success") {
    return (
      <div className="max-w-lg mx-auto text-center py-16">
        ...
        <h1 className="text-3xl font-bold mb-2">Etched</h1>
        ...
        <div className="flex flex-col gap-3">
          <Link
            ...
            className="bg-black text-white px-6 py-3 font-bold no-underline hover:bg-gray-800 transition-colors"
          >
            View Token
          </Link>
          <a
            ...
            className="border-2 border-black px-6 py-3 font-bold no-underline hover:bg-black hover:text-white transition-colors"
          >
            View Transaction
          </a>
          <button
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Create ETCH</h1>
        {isConnected ? (
          <button
            onClick={() => disconnect()}
